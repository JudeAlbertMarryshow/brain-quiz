document.addEventListener('DOMContentLoaded', function() {
  ...
  if (scoreNum >= 70) {
      // Good score
      if (resultEmoji) resultEmoji.src = 'images/good-smiley-face.webp';
      if (resultMessage) resultMessage.src = 'images/great-job.webp';
      document.body.classList.add('good-score');
  } else if (scoreNum >= 40) {
      // Medium score
      if (resultEmoji) resultEmoji.src = 'images/meh-smiley-face.webp';
      if (resultMessage) resultMessage.src = 'images/almost.webp';
      document.body.classList.add('meh-score');
  } else {
      // Bad score
      if (resultEmoji) resultEmoji.src = 'images/bad-smiley-face.webp';
